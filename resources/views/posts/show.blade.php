    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-5">
                    ...
                    <div class="d-flex mb-2">
                        <a class="text-dark text-uppercase font-weight-medium"
                           href="{{ route('post.edit', ['post'=>$post[0]->id??' ']) }}">edit</a>
                        <span class="text-primary px-2">|</span>
                        <form action="{{ route('post.destroy', ['post'=>$post[0]->id??' ']) }}" method="post"
                              onsubmit='return confirm("Rostdan ham ochirilsinmi")'>

                            @method('DELETE')
                            @csrf
                            <button type="submit" class="text-danger text-uppercase font-weight-medium">delete</button>
                        </form>
                        <span class="text-primary px-2">|</span>
                ...
                <div class="mb-5">
                    <img class="img-fluid rounded w-75 h-50 mb-4" src="/storage/{{$post[0]->photo??""}}" alt="Image">
                    <p>
                        {{ $post[0]->contents??'content' }}
                    </p>


                    <div class="mb-5">
                        <h3 class="mb-4 section-title">{{$post[0]->comments()->count()}} Comments</h3>
                        {{--                            @dd($post[0]->comments())--}}
                    ...
                    @foreach($recent_posts as $p)
                        <div class="d-flex align-items-center border-bottom mb-3 pb-3">
                            ...
                            <div class="d-flex flex-column pl-3">
                                <a class="text-dark mb-2" href="">{{$p->title??'alfa'}}</a>
                                <div class="d-flex">
